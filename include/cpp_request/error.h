...
enum class Error : uint8_t {
    ...
    // WSAStartup
    SystemIsNotReady, //< Network subsystem is unavailable.
    VersionUnsupported, //< Winsock.dll version out of range.
    NotInitialized, //< Successful WSAStartup not yet performed.

    // Resource & state
    NotEnoughMemory, //< Insufficient memory available.
    OperationInterrupted, //< Interrupted function call.
    OperationInProgress, //< Operation now in progress.
    OperationAlreadyInProgress, //< Operation already in progress.
    ProcessLimitReached, //< Too many processes.
    ...
    AddressFamilyUnsupported, //< Address family not supported by protocol family.

    // Socket
    NotASocket, //< Socket operation on nonsocket.
    SocketTypeUnsupported, //< Socket type not supported.
    AlreadyConnected, //< Socket is already connected.
    ListeningSocket, // TODO: 
    InvalidSocket, //< Specified event object handle is invalid.
    SocketShutdown, //< Cannot send after socket shutdown.
    ...
    NoData, //< Valid name, no data record of requested type.
    NoRecovery, //< This is a nonrecoverable error.
    TryAgain, //< Nonauthoritative host not found.
    ServiceTypeNotFound, //< Class type not found.
    ...
    // Data
    MessageTooLarge, //< Message too long.
...
translate_error(Error code) noexcept {
	switch (code) {
		case Error::None: return "No error.";
		case Error::SystemIsNotReady: return "Network subsystem is unavailable.";
		case Error::VersionUnsupported: return "Winsock.dll version out of range.";
		case Error::NotInitialized: return "Successful WSAStartup not yet performed.";
		case Error::NotEnoughMemory: return "Insufficient memory available.";
		case Error::OperationInterrupted: return "Interrupted function call.";
		case Error::OperationInProgress: return "Operation now in progress.";
		case Error::OperationAlreadyInProgress: return "Operation already in progress.";
		case Error::ProcessLimitReached: return "Too many processes.";
		case Error::NoBufferSpace: return "No buffer space available.";
		case Error::BadAddress: return "Bad address.";
		case Error::AddressInUse: return "Address already in use.";
		case Error::AddressNotAvailable: return "Cannot assign requested address.";
		case Error::AddressFamilyUnsupported: return "Address family not supported by protocol family.";
		case Error::NotASocket: return "Socket operation on nonsocket.";
		case Error::SocketTypeUnsupported: return "Socket type not supported.";
		case Error::AlreadyConnected: return "Socket is already connected.";
		case Error::InvalidSocket: return "Specified event object handle is invalid.";
		case Error::SocketShutdown: return "Cannot send after socket shutdown.";
		case Error::NetworkDown: return "Network is down.";
		case Error::NetworkUnreachable: return "Network is unreachable.";
		case Error::NetworkReset: return "Network dropped connection on reset.";
		case Error::HostUnreachable: return "No route to host.";
		case Error::NotConnected: return "Socket is not connected.";
		case Error::ConnectionRefused: return "Connection refused.";
		case Error::ConnectionTimedOut: return "Connection timed out.";
		case Error::ConnectionAborted: return "Software caused connection abort.";
		case Error::ConnectionReset: return "Connection reset by peer.";
		case Error::HostNotFound: return "Host not found.";
		case Error::NoData: return "Valid name, no data record of requested type.";
		case Error::NoRecovery: return "This is a nonrecoverable error.";
		case Error::TryAgain: return "Nonauthoritative host not found.";
		case Error::ServiceTypeNotFound: return "Class type not found.";
		case Error::InvalidArgument: return "Invalid argument.";
		case Error::AccessDenied: return "Permission denied.";
		case Error::WouldBlock: return "Resource temporarily unavailable.";
		case Error::MessageTooLarge: return "Message too long.";
