...
template <typename> struct to_error;

template <> struct to_error<Error> {
  constexpr Error operator()(int errc) noexcept {
    switch (errc) {
    case 0:
      return Error::None;
    case WSASYSNOTREADY:
      return Error::SystemIsNotReady;
    ...
    case WSAESOCKTNOSUPPORT:
      return Error::SocketTypeUnsupported;
    case WSAHOST_NOT_FOUND:
      return Error::HostNotFound;
    case WSANO_DATA:
      return Error::NoData;
    case WSANO_RECOVERY:
      return Error::NoRecovery;
    case WSANOTINITIALISED:
      return Error::NotInitialized;
    case WSATRY_AGAIN:
      return Error::TryAgain;
    case WSATYPE_NOT_FOUND:
      return Error::ServiceTypeNotFound;
    case WSAENETDOWN:
    ...
    case WSAEALREADY:
      return Error::OperationAlreadyInProgress;
